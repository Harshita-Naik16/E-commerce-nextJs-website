  ...
  const handleSort = useCallback(
    (e) => {
      switch (e.target.value) {
        case "lowToHigh":
          setData(
            data.slice().sort((a, b) => parseInt(a.price) - parseInt(b.price))
          );
          break;
        case "highTolow":
          setData(
    ...
    <div>
      ...
      <span className={styles.product__sort}>
        ...
        <select
          ...
          className={styles.product__sort_select}
        >
      ...
      {/* Sorting items */}
      <span className={styles.product__sort}>
        <label className={styles.product__sort_label}>Sort :</label>{" "}
        {/* use sort on data state */}
        <select
