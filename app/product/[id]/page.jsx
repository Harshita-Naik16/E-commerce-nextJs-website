  ...
  return (
    ...
    <section aria-label="product page" className={styles.product__container}>
      ...
      <div className={styles.product__info}>
        ...
        <p className={styles.product__rating_container}>
        ...
        <div className={styles.product__btn__container}>
          <div className={styles.product__wishlist_container}>
            <button
              ...
              className={`btn ${styles.product__add_to_cart}`}
            >
              Add to cart
            </button>
            {cart.itemInWishlist(id) ? (
              <button
                className={`btn ${styles.product__wishlist}`}
          ...
          <button
            className={`btn ${styles.product__buy_now}`}
